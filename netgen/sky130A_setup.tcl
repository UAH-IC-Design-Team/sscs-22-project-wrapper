...
model { sar_adc user_analog_project_wrapper.spice } blackbox
model { full_IC_1 user_analog_project_wrapper.spice } blackbox
model { VGA_final user_analog_project_wrapper.spice } blackbox
model { RF_switch user_analog_project_wrapper.spice } blackbox
model { LNA_final user_analog_project_wrapper.spice } blackbox
