...
`define USER_CONFIG_GPIO_8_INIT  `GPIO_MODE_USER_STD_OUTPUT         // In use
`define USER_CONFIG_GPIO_9_INIT  `GPIO_MODE_USER_STD_OUTPUT         // In use
`define USER_CONFIG_GPIO_10_INIT `GPIO_MODE_USER_STD_OUTPUT         // In use
`define USER_CONFIG_GPIO_11_INIT `GPIO_MODE_USER_STD_INPUT_NOPULL   // In use
`define USER_CONFIG_GPIO_12_INIT `GPIO_MODE_USER_STD_INPUT_NOPULL   // In use
...
// Also use MPRJ 14 and 15, but on caravan those are straight pads.
